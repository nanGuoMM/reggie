package com.nanGuoMM.reggie.backend.generator;
...
public class CodeGeneratorPO {
    ...
    //工程路径
    private static final String workSpace = "E:\\javaWeb\\workspace\\reggie_take_out_backend";
                ...
                .packageConfig(builder ->
                        builder.parent("com.nanGuoMM.reggie") // 设置父包名
                                ...
                                .pathInfo(Collections.singletonMap(OutputFile.entity, workSpace +
                                        "/src/main/java/com/nanGuoMM/reggie/backend/domain/" + tableName))// 设置实体类生成路径
